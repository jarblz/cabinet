  ...
  class PersonalitiesController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @personality.save
          format.html { redirect_to admin_personalities_path, notice: 'Personality was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @personality.update(personality_params)
          format.html { redirect_to admin_personalities_path, notice: 'Personality was successfully updated.' }
    ...
    def destroy
      @personality.destroy
      respond_to do |format|
        format.html { redirect_to admin_personalities_url, notice: 'Personality was successfully destroyed.' }
    ...
    private
      ...
      def personality_params
        params.require(:personality).permit(:info)
      end
  end
end
